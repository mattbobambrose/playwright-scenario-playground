...
<p class="mb-4 text-slate-700">Bookshelf is a deliberately small Ktor application used to demonstrate the playwright scenario recording and test-generation skills in this repo. It mixes static marketing pages, dynamic HTML DSL views, forms with validation, a session cart, hardcoded login, and a drag-and-drop &quot;My Shelves&quot; page.</p>
